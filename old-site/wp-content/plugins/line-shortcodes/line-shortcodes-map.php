...
add_action( 'vc_before_init', function() {
	vc_map( array(
		...
		'params'      => array(
			array(
				'type' => 'textfield',
				'heading' => __( 'List Icon', 'line-shortcodes' ),
				'param_name' => 'icon',
				'description' => __( 'Default icon for all items in the list', 'line-shortcodes' )
			),
			array(
				'type' => 'attach_image',
				'heading' => __( 'List Image', 'line-shortcodes' ),
			...
			array(
				'type' => 'checkbox',
				'heading' => __( 'Enable Icon Circle Style', 'line-shortcodes' ),
	...
	vc_map( array(
		...
		'params'      => array(
			array(
				...
				'param_name'  => 'icon',
				'description' => sprintf( __( 'FontAwesome Icon name. <a href="%s" target="blank">Full list of icons</a>', 'line-shortcodes' ), 'http://fontawesome.io/icons/' )
			),
